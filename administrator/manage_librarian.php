          ...
          <div class="row">
            ...
            <form action="../controller/librarian_control.php" method="post" enctype="multipart/form-data">
                <div class="" style="margin-top: 17px;">
                    <b>Librarian Name</b>
                    <div class="col">
                        <input class="form-control" type="text" name="librarian_name" placeholder="Librarian Name" style="margin-top: 3px;" autocomplete="off" required>
                    </div>
                </div>
                <div class="" style="margin-top: 17px;">
                    <b>Email Address</b>
                ...
                <div class="" style="margin-top: 17px;">
                    ...
                    <div class="col">
                        ...
                        <input class="form-control" type="password" name="password" placeholder="Password" style="display:none;" autocomplete="new-password" required>
                    </div>
                </div>
